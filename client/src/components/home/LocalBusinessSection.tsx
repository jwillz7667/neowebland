...
const localServices = [
  {
    ...
    description: "Transform your outdated website into a modern, mobile-friendly powerhouse that converts visitors into customers.",
  ...
  },
  {
    ...
    description: "Get found by Twin Cities customers searching for your services. Dominate local search results.",
  ...
  },
  {
    ...
    description: "Ensure your website works perfectly on all devices. Most customers browse on mobile first.",
    features: ["Responsive Design", "Touch-Friendly", "Fast Mobile Loading", "App-Like Experience"],
    color: "from-purple-500 to-pink-500"
  }
]

const twinCitiesAreas = [
...
export function LocalBusinessSection() {
  ...
  useEffect(() => {
    console.log("LocalBusinessSection mounted")
  }, [])
  ...
  return (
    <section id="local-business" className="pt-4 pb-16 px-6 relative overflow-hidden">
        ...
        >
          ...
          <h2 className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-slate-900 to-slate-600 dark:from-white dark:to-slate-300 bg-clip-text text-transparent">
            ...
            <span className="bg-gradient-to-r from-emerald-600 via-blue-600 to-purple-600 bg-clip-text text-transparent">
              Dominate Twin Cities Search
            </span>
          </h2>
          <p className="text-xl text-slate-600 dark:text-slate-400 max-w-4xl mx-auto">
            Is your website stuck in 2010? We help Minneapolis-St. Paul small businesses upgrade their outdated websites
            ...
            <CardContent>
              <ul className="space-y-3 text-slate-700 dark:text-slate-300">
                <li className="flex items-start gap-2">
                  ...
                  <span>Customers can't find you on Google searches</span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="w-2 h-2 rounded-full bg-red-500 mt-2 flex-shrink-0" />
                ...
                <li className="flex items-start gap-2">
                  <div className="w-2 h-2 rounded-full bg-red-500 mt-2 flex-shrink-0" />
                  <span>Slow loading times drive customers away</span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="w-2 h-2 rounded-full bg-red-500 mt-2 flex-shrink-0" />
          ...
          <Card className="bg-emerald-50/80 dark:bg-emerald-900/20 backdrop-blur-sm border-emerald-200 dark:border-emerald-800 shadow-lg">
            <CardHeader>
              <CardTitle className="text-2xl font-bold text-emerald-800 dark:text-emerald-300 flex items-center gap-2">
                ...
                We Fix Everything & Get You Ranking #1
              </CardTitle>
            </CardHeader>
            <CardContent>
              <ul className="space-y-3 text-slate-700 dark:text-slate-300">
                <li className="flex items-start gap-2">
                  ...
                  <span>Rank #1 for "web design Minneapolis" and local searches</span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="w-2 h-2 rounded-full bg-emerald-500 mt-2 flex-shrink-0" />
                ...
                <li className="flex items-start gap-2">
                  <div className="w-2 h-2 rounded-full bg-emerald-500 mt-2 flex-shrink-0" />
                  <span>Convert 3x more visitors into paying customers</span>
                </li>
              </ul>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-emerald-500 via-blue-600 to-purple-600 text-white border-0 shadow-2xl">
            <CardContent className="p-10">
              <h3 className="text-3xl md:text-4xl font-bold mb-4">
                Ready to Dominate Twin Cities Search Results?
              </h3>
              <p className="text-xl mb-8 text-white/90 max-w-3xl mx-auto">
                Join 200+ Minneapolis-St. Paul businesses that upgraded their websites and saw
                300% more customers within 90 days. Free consultation and quote.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                ...
                >
                  ...
                  Get Free Twin Cities SEO Audit
                </Button>
